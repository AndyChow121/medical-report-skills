...
def compile_docx(md_path: Path, docx_path: Path) -> bool:
    ...
    try:
        ...
        print('  ✗ Pandoc 转换超时', file=sys.stderr)
        return False
...
def main():
    ...
    print('✅ 完成！')
    print()
    print('  文献已自动导入 EndNote，文档已打开。')
    print('  请在 Word 中切换到 EndNote 选项卡，')
    print('  点击「Update Citations and Bibliography」完成排版。')
    print()
